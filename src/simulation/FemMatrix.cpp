...
void FemMatrix_FullEMPot_Rect(SparseMatrix<complex_t> matrix[2], size_t vars[26], real_t delta_x, real_t delta_y, real_t omega,
	...
	FemMatrix_Insert(matrix[0], vars[0], vars[12], -1.0/12.0*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[0], vars[13], -1.0/3.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[0], vars[14], -1.0/6.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[0], vars[17], -1.0/12.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	...
	FemMatrix_Insert(matrix[0], vars[1], vars[12], (1.0/12.0)*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[1], vars[13], -1.0/6.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[1], vars[14], -1.0/3.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[1], vars[17], -1.0/12.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	...
	FemMatrix_Insert(matrix[0], vars[2], vars[12], -1.0/12.0*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[2], vars[13], (1.0/3.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[2], vars[14], (1.0/6.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[2], vars[17], (1.0/12.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	...
	FemMatrix_Insert(matrix[0], vars[3], vars[12], (1.0/12.0)*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[3], vars[13], (1.0/6.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[3], vars[14], (1.0/3.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[3], vars[17], (1.0/12.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	...
	FemMatrix_Insert(matrix[0], vars[4], vars[14], -1.0/12.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[4], vars[17], -1.0/30.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	...
	FemMatrix_Insert(matrix[0], vars[5], vars[14], (1.0/12.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[5], vars[17], (1.0/30.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	...
	FemMatrix_Insert(matrix[0], vars[6], vars[12], -1.0/30.0*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[6], vars[15], -1.0/18.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[6], vars[16], -1.0/36.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	...
	FemMatrix_Insert(matrix[0], vars[7], vars[12], (1.0/30.0)*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[7], vars[15], -1.0/36.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[7], vars[16], -1.0/18.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	...
	FemMatrix_Insert(matrix[0], vars[8], vars[12], -1.0/12.0*delta_x*delta_y*square(omega)*permittivity_x/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[0], vars[8], vars[13], -1.0/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[8], vars[14], 1.0/(square(SPEED_OF_LIGHT)*permeability_z));
	...
	FemMatrix_Insert(matrix[0], vars[9], vars[12], -1.0/12.0*delta_x*delta_y*square(omega)*permittivity_x/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[0], vars[9], vars[13], 1.0/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[9], vars[14], -1.0/(square(SPEED_OF_LIGHT)*permeability_z));
	...
	FemMatrix_Insert(matrix[0], vars[10], vars[17], -(1.0/6.0)/(square(SPEED_OF_LIGHT)*permeability_z));
	...
	FemMatrix_Insert(matrix[0], vars[11], vars[17], (1.0/6.0)/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[12], vars[0], -1.0/12.0*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[12], vars[1], (1.0/12.0)*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[12], vars[2], -1.0/12.0*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[12], vars[3], (1.0/12.0)*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[12], vars[6], -1.0/30.0*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[12], vars[7], (1.0/30.0)*I*delta_y*omega*permittivity_x/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[12], vars[8], -1.0/12.0*delta_x*delta_y*square(omega)*permittivity_x/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[0], vars[12], vars[9], -1.0/12.0*delta_x*delta_y*square(omega)*permittivity_x/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[0], vars[12], vars[12], -1.0/30.0*delta_x*delta_y*square(omega)*permittivity_x/square(SPEED_OF_LIGHT) + (1.0/3.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_z));
	FemMatrix_Insert(matrix[0], vars[12], vars[15], -(1.0/6.0)/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[12], vars[16], (1.0/6.0)/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[13], vars[0], -1.0/3.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[13], vars[1], -1.0/6.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[13], vars[2], (1.0/3.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[13], vars[3], (1.0/6.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	...
	FemMatrix_Insert(matrix[0], vars[13], vars[14], -1.0/6.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT) - delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_z));
	FemMatrix_Insert(matrix[0], vars[13], vars[17], -1.0/12.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[0], vars[14], vars[0], -1.0/6.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[14], vars[1], -1.0/3.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[14], vars[2], (1.0/6.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[14], vars[3], (1.0/3.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[14], vars[4], -1.0/12.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[14], vars[5], (1.0/12.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[14], vars[8], 1.0/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[14], vars[9], -1.0/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[14], vars[13], -1.0/6.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT) - delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_z));
	FemMatrix_Insert(matrix[0], vars[14], vars[14], -1.0/3.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT) + delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_z));
	FemMatrix_Insert(matrix[0], vars[14], vars[17], -1.0/12.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[0], vars[15], vars[6], -1.0/18.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[15], vars[7], -1.0/36.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[15], vars[12], -(1.0/6.0)/(square(SPEED_OF_LIGHT)*permeability_z));
	...
	FemMatrix_Insert(matrix[0], vars[15], vars[16], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_z));
	FemMatrix_Insert(matrix[0], vars[16], vars[6], -1.0/36.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[16], vars[7], -1.0/18.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[16], vars[12], (1.0/6.0)/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[16], vars[15], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_z));
	FemMatrix_Insert(matrix[0], vars[16], vars[16], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_z));
	FemMatrix_Insert(matrix[0], vars[17], vars[0], -1.0/12.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[17], vars[1], -1.0/12.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[17], vars[2], (1.0/12.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[17], vars[3], (1.0/12.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[17], vars[4], -1.0/30.0*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[17], vars[5], (1.0/30.0)*I*delta_x*omega*permittivity_y/SPEED_OF_LIGHT);
	FemMatrix_Insert(matrix[0], vars[17], vars[10], -(1.0/6.0)/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[17], vars[11], (1.0/6.0)/(square(SPEED_OF_LIGHT)*permeability_z));
	FemMatrix_Insert(matrix[0], vars[17], vars[13], -1.0/12.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[0], vars[17], vars[14], -1.0/12.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[0], vars[17], vars[17], -1.0/30.0*delta_x*delta_y*square(omega)*permittivity_y/square(SPEED_OF_LIGHT) + (1.0/3.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_z));
	...
	FemMatrix_Insert(matrix[1], vars[0], vars[18], -1.0/9.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[0], vars[19], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[0], vars[20], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[0], vars[21], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[0], vars[24], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[0], vars[25], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[1], vars[18], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[1], vars[19], -1.0/9.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[1], vars[20], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[1], vars[21], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[1], vars[22], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[1], vars[23], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[1], vars[24], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[1], vars[25], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[2], vars[18], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[2], vars[19], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[2], vars[20], -1.0/9.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[2], vars[21], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[2], vars[22], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[2], vars[23], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[2], vars[24], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[2], vars[25], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[3], vars[18], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[3], vars[19], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[3], vars[20], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[3], vars[21], -1.0/9.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[3], vars[24], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[3], vars[25], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[4], vars[18], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[4], vars[19], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[4], vars[20], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[4], vars[21], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[4], vars[22], -1.0/90.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[4], vars[23], -1.0/180.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[4], vars[24], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[4], vars[25], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[5], vars[18], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[5], vars[19], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[5], vars[20], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[5], vars[21], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[5], vars[22], -1.0/180.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[5], vars[23], -1.0/90.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[5], vars[24], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[5], vars[25], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[6], vars[20], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[6], vars[21], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[6], vars[22], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[6], vars[23], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[6], vars[24], -1.0/90.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[6], vars[25], -1.0/180.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[7], vars[20], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[7], vars[21], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[7], vars[22], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[7], vars[23], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[7], vars[24], -1.0/180.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[7], vars[25], -1.0/90.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[8], vars[12], (1.0/12.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[8], vars[18], (1.0/3.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[8], vars[19], -1.0/3.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[8], vars[20], (1.0/6.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[8], vars[21], -1.0/6.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[8], vars[24], (1.0/12.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[8], vars[25], -1.0/12.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	...
	FemMatrix_Insert(matrix[1], vars[9], vars[12], (1.0/12.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[9], vars[18], (1.0/6.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[9], vars[19], -1.0/6.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[9], vars[20], (1.0/3.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[9], vars[21], -1.0/3.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[9], vars[24], (1.0/12.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[9], vars[25], -1.0/12.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	...
	FemMatrix_Insert(matrix[1], vars[10], vars[22], (1.0/18.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[10], vars[23], (1.0/36.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	...
	FemMatrix_Insert(matrix[1], vars[11], vars[22], (1.0/36.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[11], vars[23], (1.0/18.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[12], vars[8], (1.0/12.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[12], vars[9], (1.0/12.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[12], vars[12], (1.0/30.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[12], vars[18], (1.0/12.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[12], vars[19], -1.0/12.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[12], vars[20], (1.0/12.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[12], vars[21], -1.0/12.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[12], vars[24], (1.0/30.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[12], vars[25], -1.0/30.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[13], vars[13], (1.0/3.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[13], vars[14], (1.0/6.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[13], vars[17], (1.0/12.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[13], vars[18], (1.0/3.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[13], vars[19], (1.0/6.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[13], vars[20], -1.0/3.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[13], vars[21], -1.0/6.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[13], vars[22], (1.0/12.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[13], vars[23], -1.0/12.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[14], vars[13], (1.0/6.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[14], vars[14], (1.0/3.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[14], vars[17], (1.0/12.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[14], vars[18], (1.0/6.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[14], vars[19], (1.0/3.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[14], vars[20], -1.0/6.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[14], vars[21], -1.0/3.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[14], vars[22], (1.0/12.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[14], vars[23], -1.0/12.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[15], vars[15], (1.0/36.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[15], vars[16], (1.0/72.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[15], vars[24], (1.0/18.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[15], vars[25], (1.0/36.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[16], vars[15], (1.0/72.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[16], vars[16], (1.0/36.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[16], vars[24], (1.0/36.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[16], vars[25], (1.0/18.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[17], vars[13], (1.0/12.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[17], vars[14], (1.0/12.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[17], vars[17], (1.0/30.0)*delta_x*delta_y*square(omega)/(std::pow(SPEED_OF_LIGHT, 4)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[17], vars[18], (1.0/12.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[17], vars[19], (1.0/12.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[17], vars[20], -1.0/12.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[17], vars[21], -1.0/12.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[17], vars[22], (1.0/30.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[17], vars[23], -1.0/30.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[18], vars[0], -1.0/9.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[18], vars[1], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[18], vars[2], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[18], vars[3], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[18], vars[4], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[18], vars[5], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[18], vars[8], (1.0/3.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[18], vars[9], (1.0/6.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[18], vars[12], (1.0/12.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[18], vars[13], (1.0/3.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[18], vars[14], (1.0/6.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[18], vars[17], (1.0/12.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	...
	FemMatrix_Insert(matrix[1], vars[18], vars[20], (1.0/18.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/3.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/6.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[18], vars[21], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/6.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) + (1.0/6.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[18], vars[22], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[18], vars[23], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[18], vars[24], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[18], vars[25], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[19], vars[0], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[19], vars[1], -1.0/9.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[19], vars[2], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[19], vars[3], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[19], vars[4], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[19], vars[5], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	...
	FemMatrix_Insert(matrix[1], vars[19], vars[8], -1.0/3.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[19], vars[9], -1.0/6.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[19], vars[12], -1.0/12.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[19], vars[13], (1.0/6.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[19], vars[14], (1.0/3.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[19], vars[17], (1.0/12.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	...
	FemMatrix_Insert(matrix[1], vars[19], vars[20], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/6.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) + (1.0/6.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[19], vars[21], (1.0/18.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/3.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/6.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[19], vars[22], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[19], vars[23], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[19], vars[24], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[19], vars[25], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[20], vars[0], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[20], vars[1], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[20], vars[2], -1.0/9.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[20], vars[3], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[20], vars[4], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[20], vars[5], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[20], vars[6], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[20], vars[7], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[20], vars[8], (1.0/6.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[20], vars[9], (1.0/3.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[20], vars[12], (1.0/12.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[20], vars[13], -1.0/3.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[20], vars[14], -1.0/6.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[20], vars[17], -1.0/12.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[20], vars[18], (1.0/18.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/3.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/6.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[20], vars[19], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/6.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) + (1.0/6.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[20], vars[20], (1.0/9.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/3.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/3.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[20], vars[21], (1.0/18.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/6.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) + (1.0/3.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[20], vars[22], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[20], vars[23], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[20], vars[24], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[20], vars[25], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[21], vars[0], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[21], vars[1], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[21], vars[2], -1.0/18.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[21], vars[3], -1.0/9.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[21], vars[4], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[21], vars[5], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[21], vars[6], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[21], vars[7], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[21], vars[8], -1.0/6.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[21], vars[9], -1.0/3.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[21], vars[12], -1.0/12.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[21], vars[13], -1.0/6.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[21], vars[14], -1.0/3.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[21], vars[17], -1.0/12.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[21], vars[18], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/6.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) + (1.0/6.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[21], vars[19], (1.0/18.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/3.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/6.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[21], vars[20], (1.0/18.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/6.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) + (1.0/3.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[21], vars[21], (1.0/9.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/3.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/3.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[21], vars[22], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[21], vars[23], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[21], vars[24], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[21], vars[25], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[22], vars[0], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[22], vars[1], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[22], vars[2], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[22], vars[3], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[22], vars[4], -1.0/90.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[22], vars[5], -1.0/180.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[22], vars[6], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[22], vars[7], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[22], vars[10], (1.0/18.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[22], vars[11], (1.0/36.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[22], vars[13], (1.0/12.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[22], vars[14], (1.0/12.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[22], vars[17], (1.0/30.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[22], vars[18], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[22], vars[19], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[22], vars[20], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[22], vars[21], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[22], vars[22], (1.0/90.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/30.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/9.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[22], vars[23], (1.0/180.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/30.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/18.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[22], vars[24], (1.0/144.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[22], vars[25], (1.0/144.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[0], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[1], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[2], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[3], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[4], -1.0/180.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[5], -1.0/90.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[6], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[7], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[10], (1.0/36.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[23], vars[11], (1.0/18.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[23], vars[13], -1.0/12.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[23], vars[14], -1.0/12.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[23], vars[17], -1.0/30.0*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[23], vars[18], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[23], vars[19], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[23], vars[20], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[23], vars[21], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x));
	FemMatrix_Insert(matrix[1], vars[23], vars[22], (1.0/180.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/30.0)*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/18.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[23], vars[23], (1.0/90.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/30.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/9.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[23], vars[24], (1.0/144.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[23], vars[25], (1.0/144.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[0], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[1], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[2], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[3], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[4], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[5], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[6], -1.0/90.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[7], -1.0/180.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[8], (1.0/12.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[24], vars[9], (1.0/12.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[24], vars[12], (1.0/30.0)*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[24], vars[15], (1.0/18.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[24], vars[16], (1.0/36.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[24], vars[18], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[24], vars[19], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[24], vars[20], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[24], vars[21], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[24], vars[22], (1.0/144.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[23], (1.0/144.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[24], vars[24], (1.0/90.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/9.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/30.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[24], vars[25], (1.0/180.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/18.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) + (1.0/30.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[25], vars[0], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[1], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[2], -1.0/72.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[3], -1.0/36.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[4], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[5], -1.0/144.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[6], -1.0/180.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[7], -1.0/90.0*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[8], -1.0/12.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[25], vars[9], -1.0/12.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[25], vars[12], -1.0/30.0*I*delta_y*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_y));
	FemMatrix_Insert(matrix[1], vars[25], vars[15], (1.0/36.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[25], vars[16], (1.0/18.0)*I*delta_x*omega/(std::pow(SPEED_OF_LIGHT, 3)*permeability_x));
	FemMatrix_Insert(matrix[1], vars[25], vars[18], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[25], vars[19], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[25], vars[20], (1.0/72.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) + (1.0/12.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[25], vars[21], (1.0/36.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/12.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[25], vars[22], (1.0/144.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[23], (1.0/144.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT));
	FemMatrix_Insert(matrix[1], vars[25], vars[24], (1.0/180.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/18.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) + (1.0/30.0)*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
	FemMatrix_Insert(matrix[1], vars[25], vars[25], (1.0/90.0)*delta_x*delta_y*square(omega)*permittivity_z/square(SPEED_OF_LIGHT) - 1.0/9.0*delta_x/(square(SPEED_OF_LIGHT)*delta_y*permeability_x) - 1.0/30.0*delta_y/(square(SPEED_OF_LIGHT)*delta_x*permeability_y));
}
