...
private:
	...
	size_t m_vars_real, m_vars_fixed;
...
public:
	...
	virtual void Solve(std::vector<real_t> &charges, std::vector<real_t> &currents, const std::vector<real_t> &modes, size_t mode_count, real_t frequency) override;
